...
Log the result of your new array. */
  ...
  let nameList = graduates.map(function(i){
  return i.first_name + ` ` + i.email;
});
console.log(nameList);

// let list = 
//   graduates.filter(runner => runner.shirt_size === 'L');
...
*/
  ...
  let lowCaseAnimalNames = zooAnimals.map(function(x){
...
let lowPopulationAnimals = 
  zooAnimals.filter(low => low.population < 5);
